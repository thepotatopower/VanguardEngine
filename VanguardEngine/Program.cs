...
namespace VanguardEngine
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Card> deck1 = LoadCards.GenerateCardsFromList(LoadCards.GenerateList("dsd05.txt"), "Data Source=./cards.db;Version=3;");
            List<Card> deck2 = LoadCards.GenerateCards("dsd05.txt", "Data Source=./cards.db;Version=3;");
