...
namespace VanguardEngine
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Card> deck1 = LoadCards.GenerateCardsFromList(LoadCards.GenerateList("dsd03.txt"), "Data Source=./cards.db;Version=3;");
            List<Card> deck2 = LoadCards.GenerateCards("dsd03.txt", "Data Source=./cards.db;Version=3;");
