...
namespace VanguardEngine
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Card> deck1 = LoadCards.GenerateCardsFromList(LoadCards.GenerateList("greedon.txt", LoadCode.WithRideDeck), "Data Source=./cards.db;Version=3;");
            List<Card> deck2 = LoadCards.GenerateCardsFromList(LoadCards.GenerateList("greedon.txt", LoadCode.WithRideDeck), "Data Source=./cards.db;Version=3;");
